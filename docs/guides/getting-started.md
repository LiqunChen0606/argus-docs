...
Welcome to Supercharger -- an AI-powered personal knowledge search engine for iOS. This guide walks you through your first launch and setup.

## First Launch

When you open Supercharger for the first time, a short onboarding flow introduces the app and asks for permissions. You can grant access to:
...
You can skip any source and enable it later in **Settings > Data Sources**. Supercharger indexes everything on-device and never sends your data anywhere unless you explicitly use a cloud LLM.

## Setting Up an LLM Provider

Supercharger supports multiple AI providers. To enable AI-powered answers, summaries, and chat:
...
You bring your own API key (BYOK). Supercharger never stores keys on any server.

## Three Search Modes

Supercharger has one Search tab with three modes you can switch between:

### Plain Mode

Type natural language queries like "emails from Sarah last week" or "photos from vacation." Supercharger detects your intent, searches across all your data sources, and returns ranked results. It also handles calculations ("15% of 230"), dictionary lookups, and translations.
...
- **Indexing starts automatically.** Supercharger processes your data in the background -- extracting entities, generating embeddings, and building a knowledge graph.
...
- [Widgets](../features/widgets.md) -- Add Supercharger widgets to your home screen
